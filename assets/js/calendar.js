                    ...
                    <div class="calendar-modal__flex-block calendar-flex-block">
                        <div class="calendar-flex-block__icon">
                            <svg width="25" height="40" viewBox="0 0 25 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M22 18C22 25 13 31 13 31C13 31 4 25 4 18C4 15.6131 4.94821 13.3239 6.63604 11.636C8.32387 9.94821 10.6131 9 13 9C15.3869 9 17.6761 9.94821 19.364 11.636C21.0518 13.3239 22 15.6131 22 18Z" fill="#ED9030"/>
                        ...
                        <div class="calendar-flex-block__item">
                            <div class="calendar-flex-block__icon align-item--flex-start">
                                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <circle cx="12.5" cy="12.5" r="12.5" fill="#ED9030"/>
                                    ...
                                    <g mask="url(#mask0)">
                                        ...
                                        <path d="M14.3772 16.6243H10.5022L10.4586 17.0164C10.3411 18.0742 11.1691 18.9993 12.2334 18.9993H12.6459C13.7102 18.9993 14.5383 18.0742 14.4207 17.0164L14.3772 16.6243Z" fill="#ED9030"/>
                                        ...
                                        <circle cx="14.9375" cy="11.3118" r="0.4375" fill="#ED9030"/>
                                        <circle cx="10.1875" cy="11.3118" r="0.4375" fill="#ED9030"/>
                                        <path d="M18.5012 9.8743C12.6887 11.5618 12.3804 6.3567 11.5637 6.0618C9.31371 5.2493 10.1887 8.49933 6.5012 9.8743C6.1887 8.20763 6.8887 4.81177 12.1887 4.81177C18.8137 4.81177 22.4916 8.71579 18.5012 9.8743Z" fill="#ED9030"/>
                                        <path d="M9.8125 8.31182C10.4792 8.22848 11.8125 8.43682 11.8125 9.93682C11.8125 11.4368 11.8125 12.8118 11.8125 13.3118L12.625 13.6243" stroke="#ED9030" stroke-width="0.535714"/>
                                        <path d="M12.3125 14.7671C12.8677 14.7671 13.6128 14.6009 14.0542 14.4887C13.986 14.6887 13.8466 14.8523 13.5998 15.0991C13.275 15.4239 12.8344 15.6064 12.375 15.6064C11.9156 15.6064 11.475 15.4239 11.1502 15.0991C10.9076 14.8565 10.769 14.6944 10.6995 14.4994C11.1097 14.6114 11.7742 14.7671 12.3125 14.7671Z" stroke="#ED9030" stroke-width="0.535714" stroke-linecap="round" stroke-linejoin="round"/>
                                    </g>
                                </svg>                        
                            </div>
                            <div class="calendar-flex-block__field">
