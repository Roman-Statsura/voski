...
var nModalNew = (function () {
    var nInit = function (_options) {
        ...
        var $modalTriggers = document.querySelectorAll("[data-nModal-new]");
        var $modalContainer = document.querySelector("#nModal-container-new");
        var $modalPlaceholder = void 0;

        var modalTriggerClickEventHandler = function modalTriggerClickEventHandler(e, $modalTrigger) {
            e.preventDefault();
            var modalTarget = $modalTrigger.dataset.nmodalNew;
            var modalSize = $modalTrigger.dataset.nmodalSize ? $modalTrigger.dataset.nmodalSize : "small";
            var $modalTargetDom = document.getElementById(modalTarget);
            var $nodeToCopy = void 0;
        ...
        if (!$modalContainer) {
            // Add the nModal container
            var $_container = document.createElement("div");
            $_container.setAttribute("id", "nModal-container-new");
            if (options.backdrop) {
                $_container.classList.add('backdrop');
            }
            ...
            // Add the nModal
            var $_modalPlaceholder = document.createElement("div");
            $_modalPlaceholder.setAttribute("id", "nModal-placeholder-new");
        ...
        // nModal close event
        $modalContainer.addEventListener("click", function (e) {
            if (e.target.id === "nModal-container-new" || e.target.classList.contains("nModal-button__cancel")) {
                $modalContainer.classList.remove("active");
                $modalContainer.classList.add("hidden");
