...
$dbase = 'voski_modx';
$table_prefix = 'modx_';
$database_dsn = 'mysql:host=localhost;dbname=voski_modx;charset=utf8';
$config_options = array (
);
$driver_options = array (
);

$lastInstallTime = 1615815712;

$site_id = 'modx604f64206c3f18.80756042';
$site_sessionname = 'SN604f640086a2b';
$https_port = '443';
$uuid = 'dc59af1c-c623-4454-be49-605889fa5664';
...
if (!defined('MODX_HTTP_HOST')) {
    if(defined('PHP_SAPI') && (PHP_SAPI == "cli" || PHP_SAPI == "embed")) {
        ...
        $http_host= array_key_exists('HTTP_HOST', $_SERVER) ? htmlspecialchars($_SERVER['HTTP_HOST'], ENT_QUOTES) : 'voski.loc';
