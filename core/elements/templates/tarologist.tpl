...
{block 'content'}
        ...
        "content" => "
            <ul>
                ...
                <li><span>
                    ...
                    создавший консультацию, и закрепленный Таролог. Другие клиенты не имеют 
                    возможности вступать в дискуссию.
                </span></li>
                <li><span>
                    Полноценный профиль Таролога (минисайт), в котором собрана полная информация 
                ...
                <li><span>
                    VOSKI может быть как единственным источником дохода («полный рабочий день»), 
    ...
    {'@FILE chunks/blocks/block-list.tpl' | chunk : [
        ...
        'elements' => [[
            ...
            "iconType" => "svgElem",
            "title" => "Наличие сертификата от одной из ведущих школ Таро."
        ], [
    ...
    {'@FILE chunks/blocks/block-list.tpl' | chunk : [
        'blockTitle' => "Как получить статус Таролога VOSKI?"
        'columns' => "3",
        'footerButton' => 'true'
        'elements' => [[
            ...
            "desc" => "
                После того как Вы получите подтверждение статуса Таролога Voski, Вам станут доступны все возможности нашего сервиса.
            "
        ], [
