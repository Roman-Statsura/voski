        ...
        <div class="why-container__content why-content">
            <div class="why-content__block why-content__first">
                ...
                <div class="why-content__block--text">
                    <p>
                        В России отсутствует лицензирование астрологов: никто не проверяет образование, качество работы и 
                        адекватность методик практикующих специалистов. Экспертная группа "ОРАКУЛ" решает эту проблему.<br>
                        Все наши астрологи прошли отбор по методике, разработанной экспертной группой "ОРАКУЛ" в России. 
